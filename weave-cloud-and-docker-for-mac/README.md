...
Once it's running you will see <img alt="Docker Icon in the Mac OS menu bar" src="/guides/blob/master/weave-cloud-and-docker-for-mac/docker-for-mac-menu-bar-icon.png"
