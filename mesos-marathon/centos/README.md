...
excerpt: How-to use Weave Net with Apache Mesos & Marathon for DNS service discovery and load balancing.
...
2. Install and launch [Docker](http://docker.com) and [Weave Net](/docs/net/latest/features)
...
[Weave Net](/oss/net) networks containers on an isolated overlay network, and also provides DNS and IP address allocation.
...
![Architecture Overview](./images/diagram-1.png)
...
![Weave Net, Docker and Mesos](./images/diagram-2.png)
...
You can easily adapt this example and use it as a template for your own implementation. For more information you can contact us via [Help & Support](/help/).

## Further Reading

 * [How Weave Works](/docs/net/latest/how-it-works/)
 * [Weave Features](/docs/net/latest/features/)
 * [Integrating Docker via the API Proxy](/docs/net/latest/how-it-works/)
