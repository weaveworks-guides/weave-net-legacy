...
var ClassicAdministratorOperations = ( /** @lends ClassicAdministratorOperations */ function() {
  ...
  ClassicAdministratorOperations.prototype.list = function(callback) {
    ...
    httpRequest.headers['x-ms-version'] = '2015-07-01';
...
var RoleDefinitionOperations = ( /** @lends RoleDefinitionOperations */ function() {
   ...
   * @returns {Stream} The response stream.
   */
  RoleDefinitionOperations.prototype.createOrUpdate = function(roleDefinitionId, parameters, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
   ...
   * @returns {Stream} The response stream.
   */
  RoleDefinitionOperations.prototype.deleteMethod = function(roleDefinitionId, callback) {
    if (callback === null || callback === undefined) {
      throw new Error('callback cannot be null.');
    }
    // Validate
