...
* [Monitor the network with Weave Cortex, part of Weave Cloud](#monitor-the-network-with-weave-cortex-part-of-weave-cloud)
    * [Deploy socks shop](#monitor-the-network-with-weave-cortex-part-of-weave-cloud-deploy-socks-shop)
...
<h3 id="monitor-the-network-with-weave-cortex-part-of-weave-cloud-deploy-socks-shop">Deploy socks shop</h3>
