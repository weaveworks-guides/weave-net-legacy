...
excerpt: Weave Net & Weave Run provides a simpler way to run applications on the EC2 Container Service
...
This guide also introduces [Weave Scope](/oss/scope/), and [Weave Cloud](https://cloud.weave.works) which enables you to visualize and understand your container-based microservices.

Two types of containerized microservices are demonstrated in this guide: HTTP Servers and "Data Producers".

![AWS ECS overview diagram](./images/overview-diagram.png)
...
For more information about the weaveDNS service see [Automatic Discovery with weaveDNS](/docs/net/latest/weavedns/)

## What You Will Use

* [Weave Net](/oss/net/)
* [Weave Scope](/oss/scope/)
...
![Weave Cloud](./images/weave-cloud-main-page.png)
...
![httpserver's output](./images/httpserver.png)
...
![ECS and Weave Diagram](./images/ecs-weave-diagram.png)
...
![Weave Scope Visualization](./images/scope.png)
...
* Private Weave access between instances:
    ...
    * udp port 6784 for control in [fastdp](/docs/net/latest/using-weave/fastdp/) mode.
...
Check
[Weave's latest ECS AMIs](/docs/scope/latest/ami/) and choose an AMI depending on your configured region.
...
If you need to incorporate changes to the Weave AMI, you can do so by following [these steps](/docs/scope/latest/ami/#creating-your-own-customized-weave-ecs-ami).
...
You can easily adapt these examples and use them as a templates in your own implementation. We would be very happy to hear any of your thoughts or issues via [Help and Support](/help/).

### Further Reading

* [Discovering Containers with WeaveDNS](/docs/net/latest/weavedns/)
* [Weave Scope Docs](/docs/scope/latest/installing/#ecs)
