...
echo -n 'Saving ecs-init-1.3.0-1.el7.centos.x86_64.rpm .. '
docker run ecs-init-weave:latest cat /root/rpmbuild/RPMS/x86_64/ecs-init-1.3.0-1.el7.centos.x86_64.rpm > to-upload/ecs-init-1.3.0-1.el7.centos.x86_64.rpm
echo Done
